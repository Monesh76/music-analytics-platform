"""
Final Fixed Cloud Function for Claude LLM enrichment of music events.
Properly handles Pub/Sub message parsing and Claude LLM integration.
"""
...
def enrich_music_event(cloud_event) -> None:
    ...
    try:
        ...
        # Handle Pub/Sub message format - the message is already a dict with 'data' field
        message_data = None
        
        if hasattr(cloud_event, 'data') and cloud_event.data:
            # The cloud_event.data is already the message dict
